...
class TeacherCharacter {
  ...
  static const List<TeacherCharacter> allTeachers = [
    ...
    // きく先生 - The Ruthless Master
    TeacherCharacter(
      id: 'kiku',
      nameJp: 'きく先生',
      nameReading: 'きく先生',
      nameTh: 'อาจารย์คิคุ',
      title: 'ปรมาจารย์ผู้โหดหิน',
      icon: Icons.face_5,
      kanjiAvatar: '鬼',
      color: Color(0xFF1B5E20),
      personality: 'โหดมาก เข้มงวดที่สุด ไม่ยอมง่ายๆ',
      greeting: 'มาได้แล้วเหรอ？ วันนี้ไม่มีผ่อนปรน！ 👹',
      feedbackMessages: {
        'perfect': 'ฮึ... พอใช้ได้ แต่อย่าหลงระเริง ข้อสอบจริงยากกว่านี้！ 👹',
        'great': 'แค่นี้จะดีใจ？ ยังห่างจากระดับที่ฉันยอมรับ！',
        'good': 'ไม่ผ่าน！ คะแนนแค่นี้ต้องอายตัวเอง！ กลับไปท่องใหม่！',
        'okay': 'เสียเวลา！ กลับไปเปิดหนังสือตั้งแต่หน้าแรก！ 📕',
        'low': 'ยอมรับไม่ได้เด็ดขาด！ ลงโทษตัวเอง ท่อง 100 รอบ！ 💀',
      },
    ),

    // なっちゃん先生 - The Beautiful & Gentle
    TeacherCharacter(
      id: 'natchan',
      nameJp: 'なっちゃん先生',
      nameReading: 'なっちゃん先生',
      nameTh: 'อาจารย์นัตจัง',
      title: 'สาวสวยใจดี',
      icon: Icons.face_2,
      kanjiAvatar: '美',
      color: Color(0xFFEC407A),
      personality: 'สวย อ่อนโยน พูดจาหวานๆ ใส่ใจทุกคน',
      greeting: 'ยินดีต้อนรับค่ะ～ มาเรียนด้วยกันนะคะ 💐',
      feedbackMessages: {
        'perfect': 'สุดยอดเลยค่ะ！ คุณเก่งจนหนูอยากกอดเลย～ 💖✨',
        'great': 'เก่งมากค่ะ～ หนูประทับใจเลย อีกนิดเดียวก็เต็มแล้วนะคะ 🥰',
        'good': 'ดีมากเลยค่ะ ค่อยๆ พัฒนาไปด้วยกันนะคะ 🌷',
        'okay': 'ไม่เป็นไรนะคะ～ หนูเชื่อว่าครั้งหน้าจะดีขึ้นแน่ๆ ค่ะ 💗',
        'low': 'อย่าเพิ่งเศร้านะคะ～ หนูจะอยู่ข้างๆ สอนให้ทีละนิดเลยค่ะ 🤍',
      },
    ),
  ];
}
